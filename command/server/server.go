...
import (
	...
	"github.com/esportzvio/frietorchain/command/server/config"
	"github.com/esportzvio/frietorchain/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the Frietor Saar client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing Frietor Saar client data",
	)
