...
import (
	...
	"github.com/esportzvio/frietorchain/command/peers/add"
	"github.com/esportzvio/frietorchain/command/peers/list"
	"github.com/esportzvio/frietorchain/command/peers/status"
