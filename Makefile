...
build:
	...
	go build -o polygon-edge -ldflags="\
    	-X 'github.com/esportzvio/frietorchain/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/esportzvio/frietorchain/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/esportzvio/frietorchain/versioning.Branch=$(BRANCH)'\
		-X 'github.com/esportzvio/frietorchain/versioning.BuildTime=$(TIME)'" \
	main.go
